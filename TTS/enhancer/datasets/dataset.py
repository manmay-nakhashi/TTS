...
class EnhancerDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        for item in batch:
            ...
            # peak_normalized_audio = pyln.normalize.peak(target_wav, -1.0)

            # # measure the loudness first 
            # meter = pyln.Meter(self.target_sr) # create BS.1770 meter
            # loudness = meter.integrated_loudness(target_wav)
            # norm_audio = pyln.normalize.loudness(target_wav, loudness, -12.0)
